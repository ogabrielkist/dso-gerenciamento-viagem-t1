...
class TelaPessoaGUI(TelaBaseGUI):
    ...
    def le_opcao(self) -> str | None:
        layout = [
            [sg.Text("Gerenciamento de Pessoas", font=("Helvetica", 18), justification='center', expand_x=True)],
    ...
    def pega_dados_entidade(self, dados_atuais: dict = None) -> dict | None:
        ...
        celular = dados_atuais['celular'] if dados_atuais else ''
        identificacao = dados_atuais['identificacao'] if dados_atuais else ''
        ...
        layout = [
            ...
            [sg.Text("Identificação (CPF):", size=(12, 1)), sg.Input(identificacao, key='-ID-')],
        ...
        while True:
            ...
            if event == '-OK-':
                try:
                    ...
                    self.mostra_erro("Idade deve ser um número inteiro.")
    ...
    def mostra_lista_entidades(self, dados_lista: list):
        ...
        data = [
            [d['id'], d['nome'], d['celular'], d['identificacao'], d['idade']] 
